...
<html>
	...
	<body>
		<a href="#create-tipoPlano" class="skip" tabindex="-1"><g:message code="default.link.skip.label" default="Skip to content&hellip;"/></a>
		...
		<div id="create-tipoPlano" class="content scaffold-create" role="main">
			...
			<g:form url="[resource:tipoPlanoInstance, action:'save']" >
				<fieldset class="form">
